...
ElseIf cIdioma == "ENGLISH"
	...
	aTipoOps:= {'1-Incoming Invoice','2-Sales order','3-PO Input','4-PO Output','5-Inventory Input','6-Inventory Output','7-Sales Return','8-Outgoing Invoice','9-Dev. Sales Order'}
Else
	aTpReimp:= {'1-Imprimir na leitura','2-Imprimir ao finalizar','3-Não Imprimir','4-Imprimir Entradas ao Finalizar'}
	aTipoOps:= {'1-Nota Fiscal de Entrada','2-Pedido de Venda','3-OP Entrada','4-OP Saida','5-Mov.Interno Entrada','6-Mov.Interno Saida','7-Devolução de Venda','8-Nota Fiscal de Saída','9-Dev.Pedido vendas'}
Endif	
...
if Empty(cNumero)
	...
	if lAchouProd
		...
		Elseif Substr(cCombo1,1,1) == "9" // Dev. Pedido de Venda		
			...
			//Buscar que haya una salida por Dev. de Pedido en ZZH
			//Registrar nuevo ZZH de Ingreso
			//Relacionar la ZZH al mov anterior de salida
	...
	For iTens:= Len(aWBrowse1) to Len(aWBrowse1)
		...
		if aWBrowse1[iTens,9] = 0
			...
			if !Empty(aWBrowse1[iTens,4])
				...
				//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
				//³ Grabando en tabla ZZH -Dev. Pedido		³
				//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
				ElseIf Substr(cCombo1,1,1) == "9" // Dev. Pedido de Venda
