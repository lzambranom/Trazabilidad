...
@ aPosObj[1,1]+78 ,aPosObj[1,2]+10 MsGet oGetcEtiqueta  Var cEtiqueta			SIZE 200, 010 Valid (fVldEtq(@lOkEtq,@cEtiqueta,@cProduto,@cLote,@cInvima,@aWBrowse1,oWBrowse1,cNumero, cSerie, cClifor, cLoja, cNome, oDlg, lFiltra, dData, dDtaVal, cAutImp, _cMsgEtq, _cMsgInv) )PIXEL Of oDlg PICTURE "@!" Font oFont2 Color CLR_BLUE When lOkEtq //!Empty(cEtiqueta) .and.
...
@ aPosObj[1,1]+75, aPosObj[1,2]+500 MsGet oGet10  Var cInvima					SIZE 100, 010 Valid(fVldLote(@lOkEtq,@cEtiqueta,@cProduto,@cLote,aWBrowse1,oWBrowse1,cNumero, cSerie, cClifor, cLoja, cNome, oDlg, lFiltra, dData, dDtaVal, cAutImp, _cMsgEtq, _cMsgInv, @cInvima)) PIXEL Of oDlg Font oFont2 F3 "SZ3" Color CLR_BLUE When Empty(cInvima)
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Static Function fVldEtq(lOkEtq,cEtiqueta,cProduto,cLote,cInvima,aWBrowse1,oWBrowse1,cNumero, cSerie, cClifor, cLoja, cNome, oDlg, lFiltra, dData, dDtaVal, cAutImp, _cMsgEtq, _cMsgInv)
...
Local nSegPipe	:= At("|",csbstetq) 
Local nTerPipe	:= nTamEtq
...
Local cLote		:= if(nPriPipe > 0, AllTrim(SubStr(cEtiqueta,nPriPipe+1,nSegPipe)), space(Len(ZZH->ZZH_LOTE)) ) // m&h
//Local cInvima	:= if(nPriPipe > 0, AllTrim(SubStr(cEtiqueta,nSegPipe+1,nTerPipe)), space(Len(ZZH->ZZH_INVIM1)) ) // m&h
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Static Function fVldLote(lOkEtq,cEtiqueta,cProduto,cLote,aWBrowse1,oWBrowse1,cNumero, cSerie, cClifor, cLoja, cNome, oDlg, lFiltra, dData, dDtaVal, cAutImp, _cMsgEtq, _cMsgInv,cInvima)
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Static Function fBuscaEtq(cProduto, cLote, cInvima) // M&H
