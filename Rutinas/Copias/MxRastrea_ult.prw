...
@ aPosObj[1,1]+65, aPosObj[1,2]+390 SAY oSay9 PROMPT cCampo8	 			 	SIZE 080, 010 PIXEL Of oDlg Font oFont2 Color CLR_BLUE
...
@ aPosObj[1,1]+75, aPosObj[1,2]+390 MsGet oGet9  Var cLote						SIZE 100, 010  PIXEL Of oDlg Font oFont2 Color CLR_BLUE When Empty(cLote) 
// M&H INI
@ aPosObj[1,1]+65, aPosObj[1,2]+500 SAY oSay10 PROMPT cCampo19	 			 	SIZE 080, 010 PIXEL Of oDlg Font oFont2 Color CLR_BLUE
...
Local cInvima	:= if(nPriPipe > 0, AllTrim(SubStr(cEtiqueta,nSegPipe+1,nSegPipe+2)), space(Len(ZZH->ZZH_INVIM1)) ) //M&H
...
if Empty(cNumero)
	...
	If lAchouProd
		...
		Elseif Substr(cCombo1,1,1) = "2" // Pedido de Venda
			...
			nRegZZH := fBuscaEtq(cProduto,cLote,cInvima) //Nuevo
			If nRegZZH == 0
		...
		if aWBrowse1[iTens,9] = 0
			...
			if !Empty(aWBrowse1[iTens,4])
				...
				elseif Substr(cCombo1,1,1) == "2" // Pedido de Venda
					...
					cInvima	:= padr(Alltrim(aWBrowse1[iTens,4]),tamSx3("ZZH_INVIM1")[1]) //M&H
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Static Function fVldLote(lOkEtq,cEtiqueta,cProduto,cLote,aWBrowse1,oWBrowse1,cNumero, cSerie, cClifor, cLoja, cNome, oDlg, lFiltra, dData,
 dDtaVal, cAutImp, _cMsgEtq, _cMsgInv)
...
if Empty(cLote)
	...
	if Alltrim(cLote) == Alltrim(Substr(cProduto,1,Len(ZZH->ZZH_LOTE))) 
		...
		if lPrdNotExist
			...
			nRecNoExist:= GrvNotExist( cNumero, cSerie, cClifor, cLoja, cNome, cProduto , dData, cLote, cInvima)
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Static Function fBuscaEtq(cProduto, cLote, cInvima)
...
Static Function GrvNotExist( cNumero, cSerie, cClifor, cLoja, cNome, cProduto , dData, cLote, cInvima)
...
@ aPosObj[1,1]+16, aPosObj[1,2]+180 SAY oSay9 PROMPT cCampo8 	SIZE 080, 010 PIXEL Of oDlg Font oFont2 Color CLR_BLUE
...
// M&H
@ aPosObj[1,1]+36, aPosObj[1,2]+20 SAY oSay10 PROMPT cCampo19	SIZE 080, 010 PIXEL Of oDlg Font oFont2 Color CLR_BLUE
@ aPosObj[1,1]+46, aPosObj[1,2]+20 MsGet oGet10  Var cInvima	SIZE 150, 010 PIXEL Of oDlg Font oFont2 F3 "SZ3" Color CLR_BLUE When Empty(cInvima)
