...
////////////////////////////////////////////////////////////////////////////////////////////
User Function RELOPSCo(cNumero, dDataEmis)

Private cIdioma 		:= __LANGUAGE
Private cTitulo			:= if(cIdioma == "SPANISH","Conferencia de Rastreabilidad / Orden de Producción (SALIDAS) ",if(cIdioma == "ENGLISH","Report by Production Order","Relatório por Ordem de Produção (SAÍDAS)")) 
...
While !(cAlias)->(Eof())
	...
	dbSelectArea("SD4")
	SD4->(dbSetOrder(1))
	if SD4->(dbSeek(xFilial("SD4")+(cAlias)->ZZH_COD+cNumero))
	...
	oPrint:Say(nLin,nCol4 , Transform(nQtdOri ,"@E 99999")					,oFont2,,,,PAD_RIGHT)			
...
Local cCabec1	:= if(cIdioma == "SPANISH","Orden de Producciión: ",if(cIdioma == "ENGLISH","Production Order: ","Ordem de Produção: "))
